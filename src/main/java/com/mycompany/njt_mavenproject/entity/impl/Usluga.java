...
public class Usluga implements MyEntity {
    ...
    /** Referentna cena usluge. Može biti null, ali ako je uneta ne sme biti negativna. */
    @Column
    private Double cena;
     ...
     *                                  ako je trajanje null ili manje od 1,
     *                                  ili ako je jedinica mere null ili prazna
     */
     ...
     * Cena može biti null, ali ako je uneta ne sme biti negativna.
     *
    ...
    public void setCena(Double cena) {
        if (cena != null && cena < 0) {
            throw new IllegalArgumentException("Cena usluge ne sme biti negativna.");
        }
        this.cena = cena;
    }
}