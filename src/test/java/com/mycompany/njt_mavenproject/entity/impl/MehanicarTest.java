...
class MehanicarTest {
    ...
    @Test
    void testSetImeNull() {
        assertThrows(IllegalArgumentException.class, () -> m.setIme(null));
    }
    @Test
    void testSetImePrazno() {
        assertThrows(IllegalArgumentException.class, () -> m.setIme(""));
    }
    @Test
    ...
    void testSetPrezimeNull() {
        assertThrows(IllegalArgumentException.class, () -> m.setPrezime(null));
    }
    @Test
    void testSetPrezimePrazno() {
        assertThrows(IllegalArgumentException.class, () -> m.setPrezime(""));
    }
    @Test
    ...
    void testSetServisNull() {
        assertThrows(IllegalArgumentException.class, () -> m.setServis(null));
    }
}